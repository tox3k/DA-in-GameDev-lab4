...
Вывод AND:  
  - Поэкспериментировав я выяснил 1,2,3,5,7 эпох для обучения точно недостаточно. C 8 эпохи модель более менее начинает обучаться и начиная с 9 эпохи полностью обучается. Работа корректна модели для AND.         
    9 эпох:  

...
Вывод OR:  
  - Поэкспериментировав я выяснил 1,2,3 эпох для обучения точно не достаточно. Но вот начиная с 4 эпохи модель начинает правильно обучаться. Но для того чтобы модель полностью и правильно обучилась достаточно 5 эпох. 
    5 эпох:  
